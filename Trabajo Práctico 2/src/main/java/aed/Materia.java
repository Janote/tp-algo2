...
public class Materia {
    ...
    // Invariante:
    // materiageneral guarda en tuplas en la primer posicion la referencia al trie de la materia equivalente y en la segunda posicion 
    // el nombre de dicha materia equivalente.
